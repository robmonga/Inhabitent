...
function inhabitent_scripts() {
	wp_enqueue_style('font-awesome-cdn', 'https://use.fontawesome.com/releases/v5.7.2/css/all.css', array(), 'Version 5.7.2');
	...
	// wp_enqueue_script('tent-search-toggle', get_template_directory_uri() . "/build/js/"
