 ...
 * @author    Rob Monga <robmonga@protonmail.com>
 * @license   GPL-2.0+
 * @link      http://tent.academy.red
 * @copyright 2019 Dank Code Ltd.
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        https://github.com/robmonga/Inhabitent
 * Description:       A widget that displays business hours for the Inhabitent website
 * Version:           1.0.0
 * Author:            Rob Monga	
 * Author URI:        https://github.com/robmonga/Inhabitent
 * License:           GPL-2.0+
